...
export default function HomePage() {
  return (
    <div className="mx-auto max-w-3xl py-16">
      ...
      <h1 className="mt-4 text-5xl font-semibold tracking-tight text-zinc-900 dark:text-white">
        Lead Intelligence
      </h1>
      ...
      <div className="mt-8 flex gap-3">
        ...
        <Link
          href="/discover"
          className="rounded-md border border-zinc-300 bg-white px-4 py-2 text-sm font-medium text-zinc-900 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-white dark:hover:bg-zinc-900"
        >
          Run discovery
        </Link>
      </div>
